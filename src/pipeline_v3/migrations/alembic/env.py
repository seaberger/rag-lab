...
def get_database_url():
    ...
    if pipeline_config.database.backend != "postgresql":
        raise ValueError("Alembic migrations are only for PostgreSQL backend")

    pg_settings = pipeline_config.database.postgresql
    ...
    if pg_settings.ssl_mode != "disable":
        url += f"?sslmode={pg_settings.ssl_mode}"
