...
class QuickIntegrationTester:
    ...
    async def test_keyword_search(self) -> bool:
        ...
        search_queries = ["laser", "sensor", "power", "measurement"]
        ...
        for query in search_queries:
            try:
                ...
                results = self.pipeline.search(query, search_type="keyword", top_k=3)
    ...
    async def test_system_status(self) -> bool:
        ...
        try:
            ...
            print(
                f"  Registry stats: ✅ Retrieved ({registry_stats.get('total_documents', 0)} docs)"
            )
            ...
            self.test_results["status"] = {"success": False, "error": str(e)}
            return False
