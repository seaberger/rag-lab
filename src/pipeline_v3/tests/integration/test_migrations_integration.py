...
from core.migrations import MigrationManager, Migration, load_migrations_from_sql_files
...
def test_migration_sequence():
    ...
    try:
        ...
        for target_version in [2, 1, 0]:
            ...
            assert current_version == target_version, f"Rollback to {target_version} failed, got {current_version}"
