...
class SimpleCLITester:
    ...
    def test_normal_help_command(self):
        ...
        if exit_code == 0 and "Production Document Processing Pipeline v3" in stdout:
            ...
            print(f"     stdout contains expected text: {'Production Document Processing Pipeline v3' in stdout}")
            return False
    ...
    def test_invalid_command(self):
        ...
        if exit_code != 0:
            ...
            if "invalid arguments" in stdout.lower() or "unknown command" in stdout.lower():
                ...
                print(f"     Error message not found in output")
                return False
        else:
    ...
    def test_bad_config_path_with_help(self):
        ...
        exit_code, stdout, stderr = self.run_cli_subprocess(["--config", "nonexistent.yaml", "--help"])
...
"""
        ...
        try:
            ...
            print(f"     Test timed out (this might be expected)")
...
"""
        ...
        try:
            ...
            if log_has_traceback and not console_has_traceback:
                print(f"     Traceback in log file: ✓")
                print(f"     Traceback NOT in console: ✓")
                return True
            elif log_has_traceback:
                print(f"     Traceback in log file: ✓")
                print(f"     Traceback also in console: ⚠️  (acceptable)")
