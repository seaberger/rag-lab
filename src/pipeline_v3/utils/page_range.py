...
class PageRangeParser:
    ...
    @staticmethod
    def parse(page_spec: str, total_pages: Optional[int] = None) -> List[int]:
        """
    ...
    @staticmethod
    def _parse_range(range_spec: str, total_pages: Optional[int] = None) -> List[int]:
...
class PageProgressMonitor:
    ...
    def __init__(self, total_pages: int, page_numbers: Optional[List[int]] = None):
        """
