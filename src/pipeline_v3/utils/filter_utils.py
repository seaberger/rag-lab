...
class FilterBuilder:
    ...
    @staticmethod
    def parse_unified_filters(filters: dict[str, Any] | None) -> dict[str, Any]:
                ...
                if "has_keywords" in proc_filters:
                    if proc_filters["has_keywords"]:
                        where_clauses.append(
                            "keyword_index.keywords IS NOT NULL AND keyword_index.keywords != ''"
                        )
                    else:
                        where_clauses.append(
                            "(keyword_index.keywords IS NULL OR keyword_index.keywords = '')"
                        )
    ...
    @staticmethod
    def build_vector_metadata_filters(filters: dict[str, Any]) -> dict[str, Any] | None:
