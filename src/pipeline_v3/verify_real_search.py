...
async def verify_search_with_processed_docs():
    ...
    try:
        ...
        await pipeline.process_document(
            str(test_doc), metadata={"source": "verify_test", "type": "lmc_doc"}
        )
        ...
        test_queries = ["thermopile", "power", "sensor", "laser", "measurement"]
        ...
        if successful_searches > 0:
            ...
            print("   - Search engine finding relevant content")
            print("   - Keyword matching operational")
        else:
