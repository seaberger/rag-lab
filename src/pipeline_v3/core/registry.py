...
class DocumentRegistry:
    ...
    def update_document_state(
        self, doc_id: str, state: DocumentState, error_message: str | None = None
    ) -> bool:
    ...
    def list_documents(
        self, state: DocumentState | None = None, limit: int = 100, offset: int = 0
    ) -> list[DocumentRecord]:
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        for row in cursor.fetchall():
            ...
            stats_by_state[state] = {"count": count, "average_chunks": avg_chunks}
            total_docs += count
