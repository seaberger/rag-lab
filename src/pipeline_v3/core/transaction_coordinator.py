...
class TransactionCoordinator:
    ...
    async def execute_transaction(
        ...
        try:
            ...
            self.logger.info(f"Transaction {transaction_id}: Preparing {operation.operation_type.value} for {operation.doc_id}")
    ...
    async def _check_all_systems_health(self) -> Dict[str, bool]:
        ...
        tasks = {
            system.name: system.health_check() 
    ...
    async def _commit_all_systems(self, checkpoints: List[Checkpoint]) -> Dict[str, Any]:
        ...
        for checkpoint in checkpoints:
            try:
                ...
                errors.append(f"{checkpoint.system_name}: {str(e)}")
